...
namespace IrrationalNumbers.Tests
{
    ...
    public class ComplexFunctionsExpansionTests
    {
        ...
        // summation and subtraction of 80 functions
        ...
        [TestCase("2 *SIN(2) + 2*SIN(0.2) + 6 + COS(0.2)+ 2*SIN(0.2)+ 2*SIN(2) + 2 + COS(0.2) + TAN(0.2)+ SIN(0.2) + 2 + SIN(0.2) + 2 + TAN(0.2)+ SIN(0.2) + 4 + SIN(2) + SIN(0.2) + 2*COS(0.2) + TAN(0.2)+" +
                  ...
                  "SIN(2) + SIN(0.2) + 2 + SIN(2) + SIN(0.2) + 2 + COS(0.2) + SIN(0.2) + 2 + SIN(2) + SIN(0.2) + 2 + COS(0.2) + TAN(0.2) + SIN(0.2) + 2 + SIN(2) + SIN(0.2) + 2 + COS(0.2) + TAN(0.2) + SIN(0.2) + 2 + SIN(2) + SIN(0.2) + 2 + COS(0.2) + TAN(0.2) +" +
                  "SIN(2) + SIN(0.2) + 2 + SIN(2) + SIN(0.2) + 2 + COS(0.2) + SIN(0.2) + 2 + SIN(2) + SIN(0.2) + 2 + COS(0.2) + TAN(0.2) + SIN(0.2) + 2 + SIN(2) + SIN(0.2) + 2 + COS(0.2) + TAN(0.2) + SIN(0.2) + 2 + SIN(2) + SIN(0.2) + 2 + COS(0.2) + TAN(0.2)", -2, "10665695279351952870046504491376448469571061258296904216055874420005799408516078719953566596277031951594111943706628746024479062648484788595451594859150713486673427280232026612840439514728903536306817347326882908208276582585831", -224)]
        [TestCase("2 *SIN(2) + 2*SIN(0.2) + 6 + COS(0.2)+ 2*SIN(0.2)+ 2*SIN(2) + 2 + COS(0.2) + TAN(0.2)+ SIN(0.2) + 2 + SIN(0.2) + 2 + TAN(0.2)+ SIN(0.2) + 4 + SIN(2) + SIN(0.2) + 2*COS(0.2) + TAN(0.2)+" +
                  "SIN(2) + SIN(0.2) + 2 + SIN(2) + SIN(0.2) + 2 + COS(0.2) + SIN(0.2) + 2 + SIN(2) + SIN(0.2) + 2 + COS(0.2) + TAN(0.2) + SIN(0.2) + 2 + SIN(2) + SIN(0.2) + 2 + COS(0.2) + TAN(0.2) + SIN(0.2) + 2 + SIN(2) + SIN(0.2) + 2 + COS(0.2) + TAN(0.2) +" +
                  "SIN(2) + SIN(0.2) + 2 + SIN(2) + SIN(0.2) + 2 + COS(0.2) + SIN(0.2) + 2 + SIN(2) + SIN(0.2) + 2 + COS(0.2) + TAN(0.2) + SIN(0.2) + 2 + SIN(2) + SIN(0.2) + 2 + COS(0.2) + TAN(0.2) + SIN(0.2) + 2 + SIN(2) + SIN(0.2) + 2 + COS(0.2) + TAN(0.2) +" +
